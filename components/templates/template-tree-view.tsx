...
export function TemplateTreeView({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Tree */}
      <div className="relative border rounded-lg p-2 bg-card min-h-[400px] max-h-[600px] overflow-y-auto custom-scrollbar">
        ...
        {operationInProgress && (
          <div className="absolute inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center rounded-lg">
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-sm font-medium text-muted-foreground">Deleting template...</p>
            </div>
          </div>
        )}
